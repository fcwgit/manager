<template>
    <el-main>
        <el-form :model="PasswordForm" ref="PasswordForm" :rules="rule" label-width="0" class="login-form">
            ...
            <el-form-item prop="newPasswordRepeated" label="重复：" label-width="80px">
              <el-col>
            ...
            <el-form-item >
              <el-col>
                ...
                <hr> 
                <p>忘记密码，请联系超级管理员<span class="to" >超级</span></p>
                ...
                if (valid) { 
                    ...
                    if(newPassword != newPasswordRepeated){  
                        ...
                        setTimeout(() => {
                            ...
                            let flag = false;
                            this.$axios.post("http://localhost:8080/resetPassword.action",{
