      ...
      <el-tab-pane label="项目详细信息" >
        <el-form :model="ruleForm" ref="ruleForm" label-width="120px" class="demo-ruleForm">
          ...
          <el-form-item label="附件" prop="fileNames">
            <el-col :span="24">
              <el-input v-model="ruleForm.fileNames" :disabled="true"></el-input>
            </el-col>
          </el-form-item>
        ...
        <el-table :data="fileLog" style="width:98%" >
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button @click="downloadFile(scope.row)" type="text" size="small">查看</el-button>
            </template>
          </el-table-column>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      require.ensure([], () => {
        ...
        const filterVal8 = ['time', 'contents', 'author'];
        const list8 = this.fileLog;
        const data8 = this.formatJson(filterVal8, list8);
        var obj8 = {
          th:['设置时间', '内容', '操作员'],
          jsonData:data8,
          sheetName:'附件设置信息'
